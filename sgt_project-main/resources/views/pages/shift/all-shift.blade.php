        ...
        <div class="guard-header card mt-lg-7 rounded-0">
            <div class="card-body p-5 pb-3">
                <div class="row">
                    ...
                    <a href="/shift/edit" class="text-decro">
                        Add New Shifts
                        </a>
                    ...
                    <table id="data-table" class="w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>On 21/02/2023</td>
                                <td><a href="#" class="link text-decoration-underline">10 Guards</a></td>
                                <td><a href="#" class="link text-decoration-underline">2</a></td>
                                <td>Completed</td>
                                <td>
                                    <div class="switch">
                                        <label>
                                ...
                                <td>
                                <div class="dropdown">
  <button class="btn p-0" type="button" onclick="toggleDropdown()">
    <i class="fas fa-ellipsis-v"></i>
  </button>
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="/shift/edit">Edit shifts</a></li>
    <li><a class="dropdown-item" href="#">Download QR</a></li>
    <li><a class="dropdown-item" href="#">Delete Shift</a></li>
  </ul>
</div>
                                </td>
                                {{-- <td></td> --}}
